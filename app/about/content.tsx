            ...
            <motion.div {...fadeInUp}>
              ...
              <div className="block md:hidden">
                <div className="flex flex-col gap-4 relative flex-1 rounded-lg overflow-hidden ">
                  ...
                  />
                  <p className="text-lg leading-relaxed">
                    He completed his undergraduate degree in health and exercise science from Wake Forest University, while completing his honors research under the direction of Dr. Michael Berry. While completing his undergraduate and graduate education, he held research positions while serving in athletics as a strength and conditioning and sports performance intern and applied sports science fellow. Throughout his undergraduate degree, he also worked as a personal trainer with a wide ranging client base including youth athletes, law enforcement officers, and military personnel. He is a certified performance and sport scientist (CPSS), certified strength and conditioning specialist with distinction (CSCS, *D), and tactical strength and conditioning facilitator (TSAC-F) through the National Strength and Conditioning Association, as well as a level 1 weightlifting coach (USAW) through the United States Weightlifting Association.
                  </p>
                </div>
              </div>
